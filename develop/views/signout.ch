...
<div class="app-common-section" id="signOut" v-if="isShow" v-cloak>
        ...
        <form>
            ...
            <div class="app-form-elem-wrapper margin-bottom-10 btn-wrapper">
                <button type="button" class="common-btn common-all-length-btn common-active-btn"
                        v-if="!isSignout" @click="signoutClick" :disabled="isClickDisabled">
                    <span>确认签退</span>
                </button>
                 <button type="button" class="common-btn common-all-length-btn common-inactive-btn"
                         v-if="isSignout">
                     <span>您已签退</span>
                 </button>
            </div>
...
<script>
    window.hook.appCrm.signoutControl();
    //高德地图
    var map, geolocation;
